...
<body class="bg-light">
    <header>
        <nav class="navbar navbar-light bg-light">
            ...
            <a class="navbar-brand m-auto" href="#"><h3>Blogi</h3></a>
            <div class="dropdown">
    ...
    <main class="m-4">
        <div class="card bg-dark text-white text-center m-2">
            <div class="card-body">
                ...
                <p class="card-text">Create some posts of your intrests or read and comment on others..</p>
                <p class="card-text">Enjoy yourself in here</p>
                <a href="./about.php" class="badge badge-secondary">Click for more info About Us!</a>
            </div>
        </div>
